...
//           <h1 className="text-5xl md:text-5xl font-elegant leading-snug font-medium  text-white">
//             Complete this form <br /> to contact our team
//           </h1>
...
//   return (
//     // Changed to bg-zinc-950 for a deep black finish
//     <div className="bg-zinc-950 text-white flex items-center justify-center p-6 md:p-12 min-h-screen">
//       <div className="max-w-7xl w-full pt-20 grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
//         {/* Left Section */}
//         <div className="space-y-8">
//           <div className="flex items-center gap-2">
...
//               type="text"
//               placeholder="First Name"
//               className="col-span-1 p-5 bg-zinc-900 border border-zinc-800 rounded-2xl focus:ring-2 focus:ring-orange-500/50 outline-none placeholder:text-zinc-500 text-white"
//             />
//             <input
//               type="text"
//               placeholder="Last Name"
...
//               type="email"
//               placeholder="Email Address*"
//               className="col-span-full p-5 bg-zinc-900 border border-zinc-800 rounded-2xl focus:ring-2 focus:ring-orange-500/50 outline-none placeholder:text-zinc-500 text-white"
//             />
...
//               placeholder="Message"
//               rows={6}
//               className="col-span-full p-5 bg-zinc-900 border border-zinc-800 rounded-2xl focus:ring-2 focus:ring-orange-500/50 outline-none resize-none placeholder:text-zinc-500 text-white"
//             ></textarea>
...
const Contact = () => {
  return (
    <div className="bg-zinc-950 text-white flex items-center justify-center p-6 md:p-12 min-h-screen">
      {/* Changed items-start to items-stretch for equal column height */}
      <div className="max-w-7xl w-full pt-20 grid grid-cols-1 md:grid-cols-2 gap-16 items-stretch">
        {/* Left Section - uses flex-col to fill height */}
        <div className="flex flex-col justify-center space-y-8 ">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-[var(--font-libertinus)] leading-[1.1] font-light text-white">
              Complete this form <br /> to contact our team
            </h1>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                {[Music2, Instagram, Twitter].map((Icon, index) => (
                  <a
                    key={index}
                    href="#"
                    className="p-3 bg-zinc-900 rounded-full hover:bg-zinc-800 transition-colors border border-zinc-800"
          ...
          {/* Image with fixed pixel dimensions */}
          <div className="">
            <img
              src="https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&q=80&w=800"
              alt="City Skyline"
              className="rounded-3xl w-[450px] h-[250px] max-w-full object-cover opacity-80 hover:opacity-100 transition-opacity"
            />
          </div>
        </div>

        {/* Right Section (Form) */}
        <div className="bg-zinc-900/30 p-1 rounded-3xl">
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              type="text"
              placeholder="First Name"
            ...
            <div className="col-span-full pt-4">
              <button
                type="submit"
                className="w-full md:w-1/3 py-4 bg-white text-black rounded-full font-bold hover:bg-zinc-200 transition-all active:scale-95"
              >
                Submit
              </button>
            </div>
