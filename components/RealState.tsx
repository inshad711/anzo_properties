...
//     <div className="flex items-center hover:text-blue-900 cursor-pointer">
//       <ChevronLeft size={16} />
//       <span>Back</span>
//     </div>
...
//     <span className="hover:text-blue-900 cursor-pointer">New projects</span>
//     <ChevronRight size={14} />
...
//   return (
//     <div className="py-8 border-b border-gray-100 last:border-0 group">
//       <div className="flex flex-col md:flex-row gap-6">
//         {/* Logo Container */}
//         <div className="w-full md:w-40 h-40 flex-shrink-0 border border-gray-100 rounded-xl flex items-center justify-center p-4 bg-white shadow-sm hover:shadow-md transition-shadow">
//           <img
//             src={developer.logo}
//             alt={developer.name}
...
//             }}
//           />
//           <div className="hidden items-center justify-center text-gray-300">
//             <Building2 size={48} />
//           </div>
//         </div>
...
//             {developer.name}
//           </h3>
//           <p className="text-gray-600 text-[15px] leading-relaxed max-w-3xl line-clamp-3 md:line-clamp-none">
//             {developer.description}
//           </p>
//         </div>

//         {/* Action Button */}
//         <div className="flex items-start md:items-center justify-start md:justify-end mt-4 md:mt-0">
//           <button className="px-5 py-2.5 rounded-lg text-blue-900 bg-blue-50 hover:bg-blue-100 font-semibold text-sm transition-all whitespace-nowrap">
//             See {developer.projectsCount} projects
//           </button>
//         </div>
//       </div>
//     </div>
...
//         className="p-2 rounded-md hover:bg-gray-100 text-gray-400 disabled:opacity-30 disabled:cursor-not-allowed"
//       >
//         <ChevronLeft size={20} />
//       </button>
...
//               className="w-full pl-11 pr-4 py-3 bg-gray-50 border-none rounded-full focus:ring-2 focus:ring-blue-100 focus:bg-white transition-all outline-none text-sm placeholder:text-gray-400 shadow-sm"
//               value={searchQuery}
...
//             <button className="flex items-center space-x-2 border border-gray-200 rounded-lg px-4 py-1.5 hover:border-gray-400 transition-colors bg-white">
...
// //     <Home size={16} className="text-gray-500 hover:text-white cursor-pointer" />
// //     <ChevronRight size={14} />
// //     <span className="hover:text-white cursor-pointer">New projects</span>
// //     <ChevronRight size={14} />
...
//   return (
//     <div className="py-8 border-b border-gray-800 last:border-0 group">
//       <div className="flex flex-col md:flex-row gap-6">
//         {/* Logo Container */}
//         <div className="w-full md:w-40 h-40 flex-shrink-0 border border-gray-800 rounded-xl flex items-center justify-center p-4 bg-zinc-900 shadow-sm hover:border-gray-600 transition-all">
//           <img
//             src={developer.logo}
//             alt={developer.name}
//             className="max-w-full max-h-full object-contain filter brightness-90 hover:brightness-100"
//             onError={(e) => {
...
//             }}
//           />
//           <div className="hidden items-center justify-center text-gray-600">
//             <Building2 size={48} />
//           </div>
//         </div>
...
//             Founded in {developer.founded}
//           </p>
//           <h3 className="text-xl font-medium text-white mb-3 hover:text-blue-400 transition-colors cursor-pointer">
//             {developer.name}
//           </h3>
//           <p className="text-gray-400 text-[15px] leading-relaxed max-w-3xl line-clamp-3 md:line-clamp-none">
//             {developer.description}
//           </p>
//         </div>
...
//         {/* Action Button */}
//         <div className="flex items-start md:items-center justify-start md:justify-end mt-4 md:mt-0">
//           <button className="px-5 py-2.5 rounded-lg text-white bg-zinc-800 hover:bg-zinc-700 border border-gray-700 font-semibold text-sm transition-all whitespace-nowrap">
//             See {developer.projectsCount} projects
//           </button>
//         </div>
//       </div>
...
//         <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
//           <h1 className="text-3xl font-normal max-w-xl mx-auto tracking-tight text-white">
//             Top Real Estate Developers in UAE
//           </h1>
...
//               type="text"
//               placeholder="Search for a developer"
//               className="w-full pl-11 pr-4 py-3 bg-zinc-900 border border-gray-800 rounded-full focus:ring-2 focus:ring-blue-900 focus:border-gray-700 transition-all outline-none text-sm placeholder:text-gray-600 text-white shadow-lg"
//               value={searchQuery}
//               onChange={(e) => setSearchQuery(e.target.value)}
//             />
//           </div> */}
...
//           <div className="flex items-center space-x-2 text-[15px]">
//             <span className="text-gray-500">Filter by:</span>
//             <button className="flex items-center space-x-2 border border-gray-800 rounded-lg px-4 py-1.5 hover:border-gray-600 transition-colors bg-zinc-900">
//               <span className="text-gray-300">Emirates</span>
...
//           <Pagination
//             currentPage={currentPage}
//             totalPages={5} // Adjusted for demo
//             onPageChange={setCurrentPage}
//           />
//         )} */}
//       </div>
...
const DeveloperCard = ({ developer }: { developer: Developer }) => {
  return (
    <div className="py-6 border-b border-gray-100 last:border-0  bg-transparent">
